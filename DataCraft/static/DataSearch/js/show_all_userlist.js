   ...
   if (result != "[]") {
       ...
       $.each(dataTab.data, function (index, value) {
           ...
           if (value.is_staff==false){
            var Staff= "<label class='switch' href='javascript:void(0);' onclick='validate_user("+value.id+")'><input type='checkbox' unchecked>\
...
function validate_user(id){
    swal({
        title: "Are you sure ",
        text: "You want to Validate User ?",
        type: "info",
        showCancelButton: true,
        },
        function(){
